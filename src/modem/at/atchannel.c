...
__attribute__((unused))  static pthread_mutex_t s_writeMutex = PTHREAD_MUTEX_INITIALIZER;
 ...
 * WARNING: NO CARRIER and others are sometimes unsolicited
 */
__attribute__((unused))  static int isFinalResponse(const char *line)
{
...
{
    int ret;
	__attribute__((unused))  pthread_t tid;
    pthread_attr_t attr;
